...
async function fix() {
  const items = [
    { slug: 'woman-holding-balance', search: 'Vermeer Woman Holding Balance painting' },
    { slug: 'the-art-of-painting', search: 'Vermeer Art of Painting allegory' },
  ];
  ...
  for (const item of items) {
    ...
    if (result) {
      ...
      console.log('  ✓ Updated:', result.url.substring(0, 60) + '...');
    } else {
