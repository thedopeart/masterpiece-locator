...
export interface Era {
  ...
  historicalContext: string; // What was happening in the world that shaped the art
  keywords: string[];
...
export const ERAS: Era[] = [
  {
    ...
    historicalContext: 'Rome fell, and Europe fractured into feudal kingdoms. The Catholic Church became the only unifying force, controlling education, literacy, and artistic patronage. Vikings raided coastal monasteries. The Black Death killed a third of Europe. Crusaders marched to Jerusalem and returned with Byzantine influences. Cathedrals took centuries to build, employing generations of anonymous craftsmen. Without printing, monks hand-copied every book. Art served one purpose: bringing illiterate masses closer to God.',
...
<p>By the 1700s, <strong>Rococo</strong> lightened the mood. Where Baroque served popes and monarchs, Rococo pleased aristocrats seeking pleasure and wit. Pastel colors replaced deep shadows. Playful cherubs and flirtatious lovers replaced tortured saints. <a href="/artist/jean-honore-fragonard"><strong>Fragonard's</strong></a> famous Swing captures the style perfectly: frivolous, decorative, deliberately superficial. The French Revolution would sweep it all away.</p>`,
  ...
  },
  {
    ...
    historicalContext: 'The French Revolution beheaded a king and unleashed Napoleon across Europe. The Industrial Revolution pulled peasants into factories and cities. Steam trains connected nations. Photography arrived in 1839 and immediately threatened painting. Japanese prints flooded Paris after Commodore Perry forced open Japan. Darwin published On the Origin of Species. Marx published The Communist Manifesto. Electricity lit city streets. The old certainties were crumbling, and artists responded by questioning everything academies had taught them.',
