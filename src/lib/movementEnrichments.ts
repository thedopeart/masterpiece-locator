...
<p>Pop Art questioned what could be art and who got to decide. Was a Brillo box art if Warhol made it? The movement's ironic embrace of <a href="https://luxurywallart.com/collections/pop-culture" target="_blank" rel="noopener"><strong>pop culture</strong></a> and consumerism anticipated our image-saturated digital age. Major collections exist at the <a href="/museum/moma"><strong>MoMA</strong></a>, <a href="/museum/tate-modern"><strong>Tate Modern</strong></a>, and the Andy Warhol Museum in Pittsburgh.</p>`,
  ...
  'post-impressionism': {
    ...
    descriptionHtml: `<p><strong>Post-Impressionism</strong> wasn't a unified movement but a generation of artists who pushed beyond <a href="/movement/impressionism"><strong>Impressionism's</strong></a> emphasis on light and color. From roughly 1886 to 1910, painters like <a href="/artist/paul-cezanne"><strong>Paul Cézanne</strong></a>, <a href="/artist/van-gogh"><strong>Vincent van Gogh</strong></a>, <a href="/artist/paul-gauguin"><strong>Paul Gauguin</strong></a>, and <a href="/artist/georges-seurat"><strong>Georges Seurat</strong></a> each developed distinct personal styles that would shape <a href="/era/modern"><strong>Modern art</strong></a>.</p>

<p><a href="/artist/paul-cezanne"><strong>Cézanne</strong></a> flattened space and built forms from geometric color patches, becoming the "father of modern art." <a href="/artist/van-gogh"><strong>Van Gogh</strong></a> painted emotional intensity with swirling brushwork and <a href="https://luxurywallart.com/collections/colorful-artwork" target="_blank" rel="noopener"><strong>bold colors</strong></a>. <a href="/artist/paul-gauguin"><strong>Gauguin</strong></a> sought escape in Tahiti, using flat colors and symbolic imagery. <a href="/artist/georges-seurat"><strong>Seurat</strong></a> developed <strong>Pointillism</strong>, applying tiny dots of pure color in scientific precision.</p>
    ...
    faqs: [
      {
        ...
        answer: "<strong>Post-Impressionism</strong> (1886-1910) describes artists who moved beyond <a href=\"/movement/impressionism\"><strong>Impressionism</strong></a>. <a href=\"/artist/paul-cezanne\"><strong>Cézanne</strong></a>, <a href=\"/artist/van-gogh\"><strong>Van Gogh</strong></a>, <a href=\"/artist/paul-gauguin\"><strong>Gauguin</strong></a>, and <a href=\"/artist/georges-seurat\"><strong>Seurat</strong></a> each developed unique styles emphasizing structure, emotion, symbolism, or scientific color theory."
      },
      {
        question: "Who were the Post-Impressionist artists?",
        answer: "The main Post-Impressionists are <a href=\"/artist/paul-cezanne\"><strong>Paul Cézanne</strong></a> (geometric forms), <a href=\"/artist/van-gogh\"><strong>Vincent van Gogh</strong></a> (emotional brushwork), <a href=\"/artist/paul-gauguin\"><strong>Paul Gauguin</strong></a> (symbolic color), <a href=\"/artist/georges-seurat\"><strong>Georges Seurat</strong></a> (Pointillism), and Henri de Toulouse-Lautrec (Parisian nightlife)."
      },
      {
        question: "How is Post-Impressionism different from Impressionism?",
        answer: "<a href=\"/movement/impressionism\"><strong>Impressionists</strong></a> focused on capturing fleeting light and atmosphere. <strong>Post-Impressionists</strong> pushed further: <a href=\"/artist/paul-cezanne\"><strong>Cézanne</strong></a> emphasized underlying structure, <a href=\"/artist/van-gogh\"><strong>Van Gogh</strong></a> expressed emotion through color and brushwork, and <a href=\"/artist/paul-gauguin\"><strong>Gauguin</strong></a> used flat, symbolic color."
      },
      {
